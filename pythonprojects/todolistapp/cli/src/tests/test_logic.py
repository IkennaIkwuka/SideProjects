...
def test_app_menu_valid_input(logic: TodoLogic, input_str: str, expected: str):
    assert logic.app_menu(input_str, 4) == expected


@pytest.mark.parametrize("input_str", [("abc"), ("123"), ("-123"), ("")])
def test_app_menu_invalid(logic: TodoLogic, input_str: str):
...
def test_create_tasks_valid_inputs(logic: TodoLogic, input_str: str, expected: str):
    assert logic.create_tasks(input_str) == expected


@pytest.mark.parametrize("input_str", [("")])
def test_create_tasks_invalid(logic: TodoLogic, input_str: str):
...
def test_remove_tasks_valid(logic: TodoLogic, input_str: str, expected: str):
    assert logic.remove_tasks(input_str) == expected


@pytest.mark.parametrize("input_str", [(""), ("abc")])
def test_remove_tasks_invalid(logic: TodoLogic, input_str: str):
...
def test_edit_tasks_valid(logic: TodoLogic, input_str: str, expected: str):
    assert logic.edit_tasks(input_str) == expected


@pytest.mark.parametrize("input_str", [(""), ("abc")])
def test_edit_tasks_invalid(logic: TodoLogic, input_str: str):
